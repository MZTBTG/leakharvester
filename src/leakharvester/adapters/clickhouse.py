...
class ClickHouseAdapter(BreachRepository):
    ...
    def get_arrow_stream_process(self, table_name: str, columns: list[str] = None):
        ...
        query += " SETTINGS async_insert=1, wait_for_async_insert=0, async_insert_max_data_size=1073741824, async_insert_busy_timeout_ms=10000, send_timeout=300, connect_timeout=120, max_threads=20 FORMAT ArrowStream"
